<div class="content">
    <form class="container user-content section-page" action="portfolio-new" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                ...
                <div class="form-group">
                    <label class="label">Название
                        <input class="input" name="title" type="text" placeholder="Введите название работы" value="<?=@$works['title']?>"/>
                    </label>
                </div>
                ...
                <div class="form-group">
                    <label class="label"> Содержание
                        <textarea id="ckEditor" class="textarea" name="description" type="type" placeholder="Введите описание"></textarea>
                    </label>
                </div>

                <div class="form-group">
                    <label class="label"> Результат
                        <textarea id="ckEditor1" class="textarea" name="result" type="type" placeholder="Введите описание"></textarea>
                    </label>
                </div>

                <div class="form-group">
                    <label class="label"> Технологии
                        <textarea id="ckEditor2" class="textarea" name="technology" type="type" placeholder="Введите описание"></textarea>
                    </label>
                </div>
                ...
                <div class="col-md-3 offset-md-1">
                    <div class="form-group">
                        <label class="label">Ссылка на проект
                            <input class="input" name="linkWork" type="text" placeholder="Введите ссылку"/>
                        </label>
                    </div>
                </div>
        ...
        <div class="project-buttons">
            <div class="row">
                <div class="col-md-12 offset-md-1">
                    <input type="submit" name="newWork" value="Сохранить" class="button button--save">
